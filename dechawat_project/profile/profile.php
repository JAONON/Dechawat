                    ...
                    <div class="row g-0">
                        <div class="col-md-4" style="padding: 20px;">
                            <div style="position: relative; display: inline-block;">
                                <img id="profileImage" src="../asset/image/master/avatar.png" class="img-fluid rounded-start" alt="Profile Picture" style="width: 300px; height: auto; cursor: pointer;">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="birthday" name="birthday" value="1990-01-01">
                                </div>
                                <div class="mb-3">
                                    <label for="number" class="form-label"><strong>Number No:</strong></label>
                                    <input type="text" class="form-control" id="number" name="number" value="" placeholder="12345678901234">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phonenumber" name="phonenumber" value="" placeholder="0987654321">
                                </div>
